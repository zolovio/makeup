...
import 'package:makeup/src/feature/auth/ui/mobile_otp_verification/mobile_otp_verification_vm.dart';

class MobileOtpVerificationScreen extends StatefulWidget {
  const MobileOtpVerificationScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer(builder: (context, ref, _) {
          final _vm = ref.watch(mobileOtpVerificationVmProvider);
          return FormBuilder(
            key: _formKey,
            child: Padding(
