...
import 'package:makeup/src/admin/features/customer/home/admin_home_vm.dart';
import 'package:makeup/src/admin/features/customer/home/edit_banner/edit_banner.dart';
import 'package:makeup/src/admin/features/customer/home/edit_rewards/edit_reward.dart';
...
class AdminHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, ref, _) {
      ...
      final _userVm = ref.watch(manageUsersVmProvider);
      final _bookingVm = ref.watch(manageBookingVmProvider);
          ...
          child: ListView(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  CustomContainer(
                      upperLabel: '${_userVm.usersDataList.length}',
                      btmLabel: "Total Users"),
                  CustomContainer(
                      upperLabel: "${_bookingVm.bookingOrderList.length}",
                      btmLabel: "Total Bookings")
                ],
              ),
              SizedBox(
                height: 30.h,
